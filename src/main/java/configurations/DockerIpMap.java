...
public class DockerIpMap {
	...
	static {
	    ...
	    ips.put("account_management_ip","http://accmgmt:3000");
	    ips.put("socialStream_service_ip","http://socialstreams:3001");
	    ...
	    ips.put("social_posting_ip","http://socialposting:3011");
	    ips.put("user_engagement_service_ip","http://engagementservice:4001");
